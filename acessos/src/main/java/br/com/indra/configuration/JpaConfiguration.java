package br.com.indra.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.indra.repositories",
...
public class JpaConfiguration {
    ...
    @Value("${datasource.acesso_condominio.maxPoolSize:10}")
    ...
    @Bean
    @Primary
    @ConfigurationProperties(prefix = "datasource.acesso_condominio")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "br.com.indra.model" });
